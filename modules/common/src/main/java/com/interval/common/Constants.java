...
public class Constants {
    ...
    // Request Codes
    public static final int REQUEST_CODE_LOGIN_COORDINATOR_FIREBASE_AUTH = 1001;


    // Coordinator and ViewModel Ids
    public static final String ONBOARD_COORDINATOR_ID = "ONBOARD_COORDINATOR";
    public static final String SPLASH_VIEWMODEL_ID = "SPLASH_VIEWMODEL";
